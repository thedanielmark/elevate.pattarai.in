  ...
  return (
    <motion.div exit={{ opacity: 0 }} initial="initial" animate="animate">
      <motion.div variants={fade2} className="container">
        ...
        <Tabs className="container mt-5 text-secondary justify-content-center" style={{ width: "90%" }}>
                  ...
                  <ul className="timeline mr-3">
                    <li className="event" data-date="TRANSCEND">
                      ...
                      <p>
                        ...
                        your breakthrough research or projects.
                      </p>
                    </li>
                    <li className="event" data-date="">
                      ...
                      <p>
                        ...
                        to eat, what to wear, and which route you take. Showcase
                        your ML breakthroughs! Want to share the spotlight with
                        expert systems? Neural networks are creeping everywhere!
                        Information processing techniques, complex data
                        processing interests you? Show us your competence.
                      </p>
                    </li>
                    <li className="event" data-date="">
                    ...
                    <li className="event" data-date="">
                      ...
                      <p>
                        ...
                        about 24,000 gigabytes per second! And you need the
                        right algorithms and tools, to obtain useful information
                        from this data. Businesses rely on the interpretation of
                        big data to strategically make their future decisions.
                        Let’s talk about what you can do with this huge volume
                        of data!
                      </p>
                    </li>
                    <li className="event" data-date="">
                    ...
                    <li className="event" data-date="">
                      ...
                      <p>
                        ...
                        projects with Arduino and other similar platforms. What
                        do you prefer? MicroPython, Embedded C, Assembly? We’d
                        love to know them!
                      </p>
                    </li>
                    <li className="event" data-date="">
                      ...
                      <p>
                        ...
                        Revolution. Distributing the AI brain over the sensors
                        is what the business is talking about! Sounds
                        interesting?
                      </p>
                    </li>
                  </ul>
                  ...
                  <ul className="timeline mr-3">
                    <li className="event" data-date="EDGE">
                      ...
                      <p>
                        ...
                        period to 0.01 seconds, a crucial time reduction in any
                        surgical procedure. Interested? Engage here.
                      </p>
                    </li>
                    <li className="event" data-date="">
                      ...
                      <p>
                        ...
                        early stage and mobile technologies like 5G have a
                        crucial role to play in this space. The IoT and 5G being
                        a key enabling technology in Sustainable Building, would
                        be inextricably linked to the success story of these
                        highly connected cities of the future. Traverse the new
                        era of 5G networks with smart cities now!
                      </p>
                    </li>
                    <li className="event" data-date="">
                      ...
                      <p>
                        ...
                        education. Virtual Reality and Holograms are here to
                        stay.
                      </p>
                    </li>
                    <li className="event" data-date="">
                      ...
                      <p>
                        ...
                        with cutting-edge technologies like IoT, AR, VR etc.
                        Unearth your ideas which might bring about a significant
                    ...
                    <li className="event" data-date="">
                      ...
                      <p>
                        ...
                        can take flight thanks to lag-free guaranteed
                        connections; or production lines so predictive they can
                        prevent interruptions well before they occur. Bring out
                        your skills so people can measure, understand and manage
                        such things in real time.
                      </p>
                    </li>
                    <li className="event" data-date="">
                      ...
                      <p>
                        ...
                        the old yet stunning IC engines? So come on and pick a
                        hybrid! Join us and talk about all the different types
                        of vehicles and their characteristics and why they are
                        simply great. Connected vehicles & Drones are very
                        helpful to keep a continuous logistic operation going.
                        Is space exploration becoming too expensive? Here's a
                        call to these enthusiasts.
                      </p>
                    </li>
                  </ul>
                </div>
                  ...
                  <ul className="timeline mr-3">
                    ...
                    <li className="event" data-date="">
                      ...
                      <p>
                        ...
                        interesting) microsensors and microactuators.
                        Transducers? Rings a bell? Converging to nano?
                      </p>
                    </li>
                    <li className="event" data-date="">
                    ...
                    <li className="event" data-date="">
                      ...
                      <p>
                        ...
                        lithography processes open the door to
                        super-high-density microprocessors and memory chips.
                        Exciting?
                      </p>
                    </li>
                    <li className="event" data-date="">
                  ...
                  <ul className="timeline mr-3">
                    <li className="event" data-date="EDIFICE">
                      ...
                      <p>
                        ...
                        analytics, etc. Trends have greatly changed with the
                        introduction of new hardware, hardware with new form
                        factors and even hardware that never existed before!
                        We’d love to know the best practices you follow to be an
                        efficient app developer and how you can put the newly
                        available tools and frameworks to work!
                      </p>
                    </li>
                    <li className="event" data-date="">
                      ...
                      <p>
                        ...
                        to the cloud. Docker/Moby and Kubernetes. Hybrid cloud
                        and other buzzwords - your cloud and apps-at-scale
                        topics go here.
                      </p>
                    </li>
                    <li className="event" data-date="">
                      ...
                      <p>
                        ...
                        to know about all aspects of Quality including
                        documentation and development, automated testing and how
                        you practice techniques like CI/CD in your organization
                        or team!
                      </p>
                    </li>
                    <li className="event" data-date="">
                      ...
                      <p>
                        ...
                        available to keep our data secure and private? What
                        attacks should we be watching out for? What should I
                        know as a developer to keep the data of my users private
                        and confidential? What should I know as an enterprise to
                        handle my customer’s data safely?
                      </p>
                    </li>
                    <li className="event" data-date="">
                      ...
                      <p>
                        ...
                        establish communication between your systems? Just an
                        out-of-the-box systems thingy? You’re at the right
                        place!
                      </p>
                    </li>
                    <li className="event" data-date="">
                      ...
                      <p>
                        ...
                        kernel, rings a bell? This place is just for
                        less-fancy-yet-vital topics. Not for the light-hearted!
                        ;)
                      </p>
                    </li>
                    <li className="event" data-date="">
                      ...
                      <p>
                        ...
                        develop software in the open-source community? Where is
                        open source headed to? All such discussions, over here,
                        please!
                      </p>
                    </li>
                    <li className="event" data-date="">
                      ...
                      <p>
                        ...
                        design software? Want to share your illustration
                        theories with the world? Creators & Designers, here goes
                        your spotlight.
                      </p>
                    </li>
                  </ul>
