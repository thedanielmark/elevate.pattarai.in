  ...
  return (
    <motion.div variants="{fade1}" className="container py-3">
      <div className="container py-5 text-center">
        ...
        <h4 style={{ color: "#eeeeee", fontFamily: "Montserrat"}}>PRIVACY POLICY</h4>
        <p
        ...
        >
          ...
          you do not agree with our Privacy Policy, do not continue browsing our
          ...
          is owned by Pattarai. You can find all of our contact information on
          our
          ...
          newsletter list by sending an email with ‘unsubscribe’ in the subject
          line to &nbsp;
          ...
          we will proceed to the deletion of your data. This means that we will
          not be able to access your information and it will only be stored
          during the periods established by the applicable regulations to
          respond to requests from the competent authorities and to deal with
          possible responsibilities arising from the processing.
          <br />
          <br />
        ...
        >
          <ul>
            ...
            <li>
              ...
              Pattarai’s Data Processors (that is to say, our service providers)
              will be able to access your data to be able to develop the
              functions for which they were hired, among others: being able to
              manage your registration to the Event, accessing the Event and to
              the Event’s Website. Also, we want to inform you that these
              service providers sign Data Processing Contracts that cover all
              the appropriate security measures to guarantee the protection of
        ...
        >
          ...
          <br />
          You have the right to request information about what personal data of
          yours we are dealing with if any. The information that we can give you
          in this regard is what type of data is, what is the purpose of their
          processing or if we have communicated them to third parties or Data
          Processors, among other aspects <br /> <br />
          ...
          <strong>Right of suppression and limitation of the treatment</strong>
          <br /> In case you do not want us to continue using your data, or that
          we only use them for limited purposes, you can exercise this right by
          indicating if you want us to proceed in this way, either because you
          do not want us to continue processing the data for which we collected
          them, or because the reason that originated their processing has
          disappeared. <br /> <br />
          <strong>
          ...
          <a href="https://elevate.pattarai.in "> website</a>{" "}
          accompanied with a copy of your ID or similar document that allows the
          Organizers to properly identify you.
          <br />
        </p>
      </div>
    </motion.div>
